...
//    void decrypt_gradients(AdditivelyHE::PaillierPrivateKey privateKey);
    ...
    void boost_a_subtree(vector<vector<Tree>> &trees, int n_layer, int *id_list, int *nins_list, float *gradient_g_list, float *gradient_h_list, int *n_node, float *input_gradient_g, float *input_gradient_h);
