...
class FLModel(FedTreeBase):
    ...
    def __init__(self, n_parties, partition, alpha, n_hori, n_verti, mode, partition_mode, privacy_tech, propose_split, merge_histogram, variance, privacy_budget, depth, n_trees, min_child_weight, lambda_ft, gamma, column_sampling_rate, verbose, n_parallel_trees, learning_rate, objective, num_class, n_device, max_num_bin, tree_method):
